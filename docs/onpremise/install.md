...
| -------- | ------ | -------- |
| High | High-Priority Amon Alert 24/7/365. | Requires **immediate human action**. |
| Medium | High-Priority Amon Alert during **business hours only**. | Requires human action within 24 hours. |
| Low | Low-Priority Amon Alert 24/7/365. | Requires human action at some point. |
| Notification | Suppressed Amon Event. | No response required. Informational only. |
